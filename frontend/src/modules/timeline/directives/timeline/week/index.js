module.exports = () => {
  return {
    ...
    controller: ['$scope', $scope => {
      ...
      $scope.getTimeOfDayColor = () => `rgba(255, 255, 255, ${Math.sin(new Date($scope.now).getHours() / 23)})`;
      $scope.getInverseTimeOfDayColor = () => `rgba(255, 255, 255, ${1 - Math.sin(new Date($scope.now).getHours() / 23)})`;
